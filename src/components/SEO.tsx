...
export function SEO({
  ...
  return (
    <Head>
      ...
      {/* adress bar color, same as bgcolor looks good. match this in manifest aswell */}
      <meta name="theme-color" content="#fafafa" />
      <meta name="description" content={description} />
      {/* manifest and icons */}
      <link rel="manifest" href="/manifest.json" />
      <link rel="icon" type="image/svg+xml" href="/icons/favicon.svg" />
      <link rel="apple-touch-icon" href="/icons/favicon-maskable-512x512.png" />
      {/* OG Metadata */}
      ...
      {/* twitter uses og tags for these if not provided so technically not needed? */}
